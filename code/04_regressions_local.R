...
### 1 ----- create the dataframe for regressions
...
if(us_supply_iv == TRUE){
  iv_us <- fread(paste0("../outputs/us_supply_3digit_nace_nace_", year, ".csv"))
...
# add ECU data as IV
if(ecu_iv == TRUE){
  #iv_ecu <- fread(paste0("../outputs/ecu_vat_iv.csv"))
  iv_ecu <- fread(paste0("../outputs/ecu_vat_iv_no_limit.csv"))
  
  mdf3 <- merge(
    mdf3,
    dplyr::select(iv_ecu, ind1, ind2, iv_io_norm),
    by = c("ind1", "ind2"),
    all.x = TRUE,
    all.y = FALSE
  )
...
summary(iv_egk <- ivreg::ivreg(egk_coagg ~ io_standard_wiot + lab_standard | USA + swe_lab_standard, data = mdf3))
summary(iv_porter <- ivreg::ivreg(coagg_porter ~ io_standard_wiot + lab_standard | USA + swe_lab_standard, data = mdf3))
...
summary(iv_egk <- ivreg::ivreg(egk_coagg ~ io_standard_wiot + lab_standard | USA + swe_lab_standard, data = iv_mdf3))
summary(iv_porter <- ivreg::ivreg(coagg_porter ~ io_standard_wiot + lab_standard | USA + swe_lab_standard, data = iv_mdf3))
#summary(iv_egk <- ivreg::ivreg(egk_coagg ~ io_standard_vat + lab_standard | USA + swe_lab_standard, data = iv_mdf3))
#summary(iv_porter <- ivreg::ivreg(coagg_porter ~ io_standard_vat + lab_standard | USA + swe_lab_standard, data = iv_mdf3))
...
### 3 ----- MNE / domestic baseline models

# mne / domestic models -- EGK
summary(egk_mm01 <- lm(egk_coagg ~ io_standard_wiot + lab_standard, data = mdf3))
summary(egk_mm02 <- lm(egk_coagg_mne ~ io_standard_wiot + lab_standard, data = mdf3))
summary(egk_mm03 <- lm(egk_coagg_local ~ io_standard_wiot + lab_standard, data = mdf3))
...
summary(porter_mm01 <- lm(coagg_porter ~ io_standard_wiot + lab_standard, data = mdf3))
summary(porter_mm02 <- lm(coagg_porter_mne ~ io_standard_wiot + lab_standard, data = mdf3))
summary(porter_mm03 <- lm(coagg_porter_local ~ io_standard_wiot + lab_standard, data = mdf3))
summary(porter_mm04 <- lm(coagg_porter_mne_local ~ io_standard_wiot + lab_standard, data = mdf3))
...
summary(inter01 <- lm(egk_coagg ~ io_standard_wiot * lab_standard, data = mdf3))
summary(inter02 <- lm(coagg_porter ~ io_standard_wiot * lab_standard, data = mdf3))
summary(inter01 <- lm(egk_coagg ~ io_standard_vat * lab_standard, data = mdf3))
summary(inter02 <- lm(coagg_porter ~ io_standard_vat * lab_standard, data = mdf3))
summary(inter01 <- lm(egk_coagg ~ io_norm * sr_norm, data = mdf3))
summary(inter02 <- lm(coagg_porter ~ io_norm * sr_norm, data = mdf3))
...
summary(egk_inter01 <- lm(egk_coagg ~ io_standard_wiot * lab_standard, data = mdf3))
summary(egk_inter02 <- lm(egk_coagg_mne ~ io_standard_wiot * lab_standard, data = mdf3))
summary(egk_inter03 <- lm(egk_coagg_local ~ io_standard_wiot * lab_standard, data = mdf3))
...
summary(p_inter01 <- lm(coagg_porter ~ io_standard_wiot * lab_standard, data = mdf3))
...
#summary(egk_interplot <- lm(egk_coagg ~ io_standard_vat * lab_standard, data = mdf3))
